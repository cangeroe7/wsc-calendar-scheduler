...
export default function BookingCalendar() {
  const [selectedDate, setSelectedDate] = useState<Date>(new Date(2024, 6, 22)) // July 22, 2024
  const [selectedTime, setSelectedTime] = useState<string | null>("11:00am")
  ...
  return (
    <Card className="w-full max-w-5xl overflow-hidden rounded-lg border bg-white shadow-lg">
      <div className="grid grid-cols-1 md:grid-cols-3">
        ...
        <div className="border-b border-r p-6 md:border-b-0 bg-secondary">
          <div className="mb-6">
