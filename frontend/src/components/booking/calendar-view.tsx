    ...
    const renderDays = () => {
        ...
        while (day <= endDateOfCalendar) {
            for (let i = 0; i < 7; i++) {
                ...
                ${selectedDate && day.toISOString().slice(0,10) === selectedDate.toISOString().slice(0,10) ? "bg-primary text-primary-foreground hover:bg-primary hover:text-primary-foreground" : "cursor-pointer hover:bg-black/10"} 
