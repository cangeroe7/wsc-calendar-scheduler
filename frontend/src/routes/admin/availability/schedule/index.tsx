...
import DateSpecificHoursModal from "@/components/date-specific-hours-modal"
import WeeklyAvailabilityCompact from "@/components/weekly-availability-compact"

export const Route = createFileRoute('/admin/availability/schedule/')({
    ...
    return (
        <div className="min-h-screen bg-secondary/30 p-4 md:p-8">
            <div className="mx-auto max-w-6xl">
                <h1 className="mb-8 text-3xl font-bold text-black">Schedule</h1>
